...
const UIIconPanelRightOpenPartial: React.FC<IIconProps> = (props) => {
  ...
  return (
    <svg className={className} aria-hidden="true" viewBox="0 0 26 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        strokeWidth="2"
        d="M20,1l0,20l3,0c1.104,0 2,-0.896 2,-2l0,-16c0,-1.104 -0.896,-2 -2,-2l-3,0Z"
      />
      <path
        stroke={color}
        strokeLinecap="round"
...
export default UIIconPanelRightOpenPartial;
