...
const UIIconPanelLeftOpenPartial: React.FC<IIconProps> = (props) => {
  ...
  return (
    <svg className={className} aria-hidden="true" viewBox="0 0 26 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        strokeWidth="2"
        d="M6,1l0,20l-3,0c-1.104,0 -2,-0.896 -2,-2l-0,-16c-0,-1.104 0.896,-2 2,-2l3,0Z"
      />
      <path
        stroke={color}
        strokeLinecap="round"
...
export default UIIconPanelLeftOpenPartial;
