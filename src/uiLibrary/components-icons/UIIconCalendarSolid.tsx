//flowbite.com/icons/ IconSize:32px  StrokeWidth:2px IconSize:32px  StrokeWidth:2px

import EnumIconSvgStyle from "./enum/EnumIconSvgStyle";
import useIconStyling from "./hooks/UseIconStyling";
import IIconProps from "./interfaces/IIconProps";

const UIIconCalendarSolid: React.FC<IIconProps> = (props) => {
...
export default UIIconCalendarSolid;
