 ...
 * @returns
 */
const UISpinner: React.FC<ISpinnerProperties> = (props) => {
  var sizeClass = useSizeStyle("spn", props);
  var variantClass = useVariantStyle("spn", props);
  var className = classNames("ui-spinner", variantClass, sizeClass);

  // Spinner Circle Path
  const spinnerCirclePath = (
    <path
