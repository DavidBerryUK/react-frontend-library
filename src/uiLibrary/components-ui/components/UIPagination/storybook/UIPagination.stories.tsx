...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "page pagination. use the left and right arrow keys to change the page number, press shift to just by 10 pages, or press control to just to the first or last page.",
      },
    },
  },
  tags: ["autodocs"],
